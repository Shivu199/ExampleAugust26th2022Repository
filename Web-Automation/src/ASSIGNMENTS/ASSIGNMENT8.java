...
import org.openqa.selenium.chrome.ChromeDriver;
	...
	private static void createUser()
	{
		try
		{
			...
			Thread.sleep(4000);
			oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys("Nagu");
			Thread.sleep(3000);
	...
	private static void CreateProject()
	{
		try
		{
			...
			Thread.sleep(3000);
			oBrowser.findElement(By.id("projectPopup_projectNameField")).sendKeys("SELES PROJECT");
			Thread.sleep(4000);			
	...
	private static void CreateTasks()
	{
		try
		{
			...
			Thread.sleep(4000);
			oBrowser.findElement(By.id("createTasksPopup_ProjectNameField")).sendKeys("Shiva");
			Thread.sleep(3000);
